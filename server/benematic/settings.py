...
SECRET_KEY = 'wz21sc-bevv=j=$=#xdn(v#o1xr5&an4z6=+!bp01z^#a-mkl+'

# DEBUG = False
DEBUG = True

ROOT_URLCONF = 'benematic.urls'

WSGI_APPLICATION = 'benematic.wsgi.application'
...
# Static files - https://docs.djangoproject.com/en/1.10/howto/static-files/
STATIC_URL = '/assets/'
STATICFILES_DIRS = (
